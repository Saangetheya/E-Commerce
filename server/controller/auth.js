  ...
  async postSignup(req, res) {
    ...
    if (!name || !email || !password || !cPassword) {
      error = {
        ...
        userRole: "Filed must not be empty",
      };
          ...
          try {
            ...
            if (data) {
              ...
              let newUser = new userModel({
                ...
                userRole: myUserRole, // Field Name change to userRole from role
              });
              newUser
                .save()
                .then((data) => {
                  return res.json({
                    success: "Account successfully created! Enjoy!",
                  });
                })
                .catch((err) => {
                  console.log(err);
