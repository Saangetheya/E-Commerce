    ...
    <Fragment>
        ...
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          ...
          <div className="flex items-right col-span-2 lg:col-span-1 flex justify-end">
            ...
            <div
              ...
              className="hover:bg-gray-300 rounded-lg px-2 py-2 cursor-pointer"
              title="Favorites"
            >
              <svg
                className={`${
      ...
      //  Q 10,60 10,30 z"
            ...
            {localStorage.getItem("jwt") ? (
              <Fragment>
                <div
                  className="userDropdownBtn hover:bg-gray-700 px-2 py-2 rounded-lg relative"
                  title="Logout"
                >
                  <svg
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={3}
                      d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18  "
                    />
                  </svg>
                            ...
                            <span>
                              ...
                              >
                                <path
                                  ...
                                  strokeLinejoin="round"
                                  strokeWidth={2}
                                  d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"
                                />
                              </svg>
                            </span>
                            ...
                            <span>
                              ...
                              >
                                <path
                                  ...
                                  strokeLinejoin="round"
                                  strokeWidth={2}
                                  d="M10.325 4.317c.426-1.756  3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"
                                />
                                <path
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
              ...
              >
                ...
                >
                  <path
                    ...
                    d="M11 16l-4-4m0 0l4-4m-4 4h14m-5       0  3 0  3 0 "
                  />
                </svg>
              </div>
            )}
