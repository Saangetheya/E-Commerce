        ...
        <div className="relative bg-white w-11/12 md:w-3/6 shadow-lg flex flex-col items-center space-y-4  overflow-y-auto px-4 py-4 md:px-8">
          ...
          <div className="flex flex-col space-y-1 w-full">
            ...
            <select
              ...
              id="status"
            >
              <option name="status" value="Order Not Received">
                Order Not Received
              </option>
              <option name="status" value="Order Received">
                Order Received
              </option>
              <option name="status" value="Shipment Complete">
                Shipment Complete
              </option>
              <option name="status" value="Delivered">
                Delivered
              </option>
              <option name="status" value="Abort">
                Abort
              </option>
            </select>
          </div>
